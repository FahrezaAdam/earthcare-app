                                ...
                                child: Column(
                                  ...
                                  children: [
                                    ...
                                    GestureDetector(
                                      onTap: _secondsRemaining == 0
                                          ? () async {
                                              ...
                                              if (success) {
                                                ...
                                                ScaffoldMessenger.of(context).showSnackBar(
                                                  SnackBar(
                                                    content: Text(error ?? 'Gagal mengirim ulang kode'),
                                      ...
                                      child: Text(
                                        ...
                                        style: TextStyle(
                                          fontSize: 12,
                                          fontWeight: FontWeight.bold,
                                          color: _secondsRemaining > 0 ? Colors.black38 : const Color(0xFF1B4332),
                                    ...
                                    OutlinedButton(
                                      ...
                                      child: const Text(
                                        'Ganti Email',
                                        style: TextStyle(color: Color(0xFF1B4332), fontWeight: FontWeight.bold, fontSize: 14),
                                      ),
                                    ),
                                  ],
                                ),
