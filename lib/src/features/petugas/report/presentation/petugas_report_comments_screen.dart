...
class PetugasReportCommentsScreen extends ConsumerStatefulWidget {
  final ReportModel report;

  const PetugasReportCommentsScreen({super.key, required this.report});

  @override
  ConsumerState<PetugasReportCommentsScreen> createState() =>
      _PetugasReportCommentsScreenState();
}

class _PetugasReportCommentsScreenState extends ConsumerState<PetugasReportCommentsScreen> {
